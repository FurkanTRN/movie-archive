    ...
    return (
        <nav aria-label="Pagination" className={cx("flex items-center justify-between md:hidden", className)}>
            ...
            <span className="text-sm text-fg-secondary">
                Sayfa <span className="font-medium">{page}</span> / <span className="font-medium">{total}</span>
            </span>
                ...
                {({ pages, currentPage, total }) => (
                    <>
                        ...
                        <div className="flex justify-center text-sm whitespace-pre text-fg-secondary md:hidden">
                            Sayfa <span className="font-medium">{currentPage}</span> / <span className="font-medium">{total}</span>
                        </div>
                    </>
                )}
            </Pagination.Context>
            ...
            <Pagination.Root {...props} page={page} total={total}>
                <Pagination.Context>
                    {({ pages }) => (
                        <ButtonGroup size="md">
                            <Pagination.PrevTrigger asChild>
                                <ButtonGroupItem iconLeading={ArrowLeft}>{isDesktop ? "Önceki" : undefined}</ButtonGroupItem>
                            </Pagination.PrevTrigger>
                            ...
                            <Pagination.NextTrigger asChild>
                                <ButtonGroupItem iconTrailing={ArrowRight}>{isDesktop ? "Sonraki" : undefined}</ButtonGroupItem>
                            </Pagination.NextTrigger>
                        </ButtonGroup>
                    )}
                </Pagination.Context>
