        ...
        <div className={cx("w-full in-data-input-wrapper:w-max", className)}>
            ...
            <div className="relative grid w-full items-center">
                <select
                    ...
                    className={cx(
                        "appearance-none rounded-lg bg-primary px-3.5 py-2 text-md font-medium text-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset placeholder:text-fg-quaternary focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:bg-disabled_subtle disabled:text-disabled",
